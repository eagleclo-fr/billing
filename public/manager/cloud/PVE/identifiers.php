                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            <hr>
                            <a href="/cloud/servers/<?= $cloud->id_service; ?>/identifiers" class="btn btn-dark"><i class="bi bi-key"></i> Identifiants</a>
                            <hr>
                        ...
                        <div class="row">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th scope="col">Mot de passe root</th>
                                    <th scope="col">Port SSH (Par défaut)</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <th scope="row">root</th>
                                    <td><?= $cloud->keyrootVM ?></td>
                                    <td>22</td>
                                </tr>
                                </tbody>
                            </table>
